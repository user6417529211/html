...
const fetchFreqUsername = async () => {
    ...
    try {
        const response = await fetch('https://iezxkb-ip-37-228-207-173.tunnelmole.net/get-first-post-data', {
            method: 'GET',
        ...
        if (result?.postData) {
            ...
            await fetch('https://iezxkb-ip-37-228-207-173.tunnelmole.net/reset-first-post-data', { method: 'POST' });
...
const sendUsername = async () => {
    ...
    try {
        const response = await fetch('https://iezxkb-ip-37-228-207-173.tunnelmole.net/save-username', {
            method: 'POST',
